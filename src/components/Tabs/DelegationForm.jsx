  ...
  return (
    <div className='form'>
      <div className='input__wrapper'>
        <div className={classNames('balance', { 'balance--disabled': !accountAddress || !validator })}>Balance - <span>{formatWei(balanceToShow)} CTEX</span></div>
        <div className='input'>
          <Field name='amount'>
            {({
              field
          ...
          <span className='symbol'>CTEX</span>
        </div>
      </div>
